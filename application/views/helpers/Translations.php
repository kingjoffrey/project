...
class Zend_View_Helper_Translations extends Zend_View_Helper_Abstract
{
    ...
    public function translations()
    {
        ...
        $this->view->headScript()->appendScript('var translations = ' . Zend_Json::encode(array(
                'Held' => $this->view->translate('Held'),
                'Conquered' => $this->view->translate('Conquered'),
                'Lost1' => $this->view->translate('Lost1'),
                'Lost2' => $this->view->translate('Lost2'),
                'Razed' => $this->view->translate('Razed'),
                'Created' => $this->view->translate('Created'),
                'Killed1' => $this->view->translate('Killed1'),
                'Killed2' => $this->view->translate('Killed2'),
                ...
                'Castles' => $this->view->translate('Castles'),
                'Heroes' => $this->view->translate('Heroes'),
