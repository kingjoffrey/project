...
EventsControls = function (camera, domElement) {
    ...
    function onContainerMouseDown(event) {
        EventsControls.button = event.button
        ...
        if (_this.focused) {
            if (_this.displacing) {
                ...
                try {
                    ...
                    if (_this.fixed.x == 1) {
                        pos.x = _this.previous.x
                    }
                    ;
                    if (_this.fixed.y == 1) {
                        pos.y = _this.previous.y
                    }
                    ;
                    if (_this.fixed.z == 1) {
                        pos.z = _this.previous.z
                    }
                    ;
                ...
                _this.mouseMove();
                _this._selGetPos(_this.focused.position);
            }
        }
        else {
