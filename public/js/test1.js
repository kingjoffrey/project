var Test = new function () {
    ...
    this.getDecalGeometry = function (mesh, position, direction) {
        var decalGeometry = new THREE.DecalGeometry(
            mesh, // it has to be a THREE.Mesh
    ...
    this.getDecalMaterial = function () {
...
var CreateSimpleMesh = new function () {
    ...
    this.init = function () {
        ...
        //var edges = new THREE.FaceNormalsHelper( grassMesh, 20, 0x00ff00, 1 );
        //grassMesh.add(edges)
